...
def Node_1():
    return node("Page 1", [2, 5], 5, 7)

@application.route("/Node_2.html")
def Node_2():
    return node("Page 2", [3], 7, 11)

@application.route("/Node_3.html")
def Node_3():
    return node("Page 3", [4, 5], 11, 17)

@application.route("/Node_4.html")
def Node_4():
    return node("Page 4", [3, 7, 6], 17, 18)

@application.route("/Node_5.html")
def Node_5():
    return node("Page 5", [6], 18, 21)

@application.route("/Node_6.html")
def Node_6():
    return node("Page 6", [5, 3], 21, 26)

@application.route("/Node_7.html")
def Node_7():
    return node("Page 7", [3], 0, 5)
...
password_bfs = "82459480915326473571117135"
password_dfs = "82459415326411713573571809"
